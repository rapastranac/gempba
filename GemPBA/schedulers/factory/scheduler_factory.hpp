            ...
            switch (provider) {
                case MPI: {
                    switch (topology) {
                        ...
                        case CENTRALIZED: {
                            utils::log_and_throw("Centralized topology not implemented for MPI");
                        }
                        default: {
                            utils::log_and_throw("Invalid topology");
                        }
                    }
                }
                case UPC: {
                    switch (topology) {
                        ...
                        case CENTRALIZED: {
                            utils::log_and_throw("Centralized topology not implemented for UPC");
                        }
                        default: {
                            utils::log_and_throw("Invalid topology");
                        }
                ...
                default: {
                    utils::log_and_throw("Invalid provider");
                }
            }
        }
    };
