...
int run(const benchmark_params &p_params) {
    ...
    multithreading_benchmark v_instance(v_node_manager, v_load_balancer);

    auto v_function = std::bind(&multithreading_benchmark::explore, &v_instance, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4, std::placeholders::_5);
