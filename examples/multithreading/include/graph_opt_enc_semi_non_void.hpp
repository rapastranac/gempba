#ifndef GEMPBA_MULTITHREADING_GRAPH_OPT_ENC_SEMI_NON_VOID_HPP
#define GEMPBA_MULTITHREADING_GRAPH_OPT_ENC_SEMI_NON_VOID_HPP
...
class multithreading_graph_opt_enc_semi_non_void final : public VertexCover {
...
public:
    multithreading_graph_opt_enc_semi_non_void(gempba::node_manager &p_node_manager, gempba::load_balancer &p_load_balancer) :
        m_node_manager(p_node_manager), m_load_balancer(p_load_balancer) {
        this->m_function = std::bind(&multithreading_graph_opt_enc_semi_non_void::mvc, this, _1, _2, _3, _4);
    }

    ~multithreading_graph_opt_enc_semi_non_void() override {
    }
...
#endif //GEMPBA_MULTITHREADING_GRAPH_OPT_ENC_SEMI_NON_VOID_HPP
