...
void foo(int tid, MyClass instance, float f, double d, void *parent = nullptr)
    ...
    */
    ...
    branchHandler.try_push_local<void>(foo, tid, rHolder_l);
    branchHandler.try_push_local<void>(foo, tid, rHolder_m);
...
void foo1(int tid, MyClass instance, float f, double d, void *parent = nullptr)
    ...
    branchHandler.try_push_local<void>(foo1, tid, rHolder_l);
    branchHandler.try_push_local<void>(foo2, tid, rHolder_m);
