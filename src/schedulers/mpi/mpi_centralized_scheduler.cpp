...
namespace gempba {
    void mpi_centralized_scheduler::send_final_solution_to_center(node_manager &p_branch_handler) const {
    ...
    void mpi_centralized_scheduler::collect_stats_data(const node_manager &p_branch_handler) {
    ...
    void mpi_centralized_scheduler::task_funneling(node_manager &p_branch_handler) {
    ...
    void mpi_centralized_scheduler::update_score(node_manager &p_branch_handler) {
