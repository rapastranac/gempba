...
namespace gempba {
    ...
    void mpi_centralized_scheduler::collect_stats_data2(const branch_handler &p_branch_handler) {
    ...
    void mpi_centralized_scheduler::task_funneling2(branch_handler &p_branch_handler) {
